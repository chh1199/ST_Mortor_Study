...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PA0     ------> ADC1_IN1
    */
    GPIO_InitStruct.Pin = M1_BEMF_W_Pin|M1_BEMF_V_Pin;
  ...
  */
    ...
    PC4     ------> ADC2_IN5
    */
    GPIO_InitStruct.Pin = M1_BEMF_U_Pin|M1_TEMPERATURE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA0     ------> ADC1_IN1
    */
    HAL_GPIO_DeInit(GPIOC, M1_BEMF_W_Pin|M1_BEMF_V_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PC4     ------> ADC2_IN5
    */
    HAL_GPIO_DeInit(GPIOC, M1_BEMF_U_Pin|M1_TEMPERATURE_Pin);
